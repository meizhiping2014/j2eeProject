...
<html>
	...
	<body>
		...
		<form id="user-form" class="form-horizontal" role="form" action="${ctx}/control/user/add" method="post" >
		
			<div class="form-group">
			    <label for="account" class="col-sm-2 control-label"><span class="error-tip">*&nbsp;</span>账户名称：</label>
			    <div class="col-sm-3">
			      <input type="text" class="form-control" name="account" id="account" placeholder="请输入账户名称" maxlength="16" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-3">
			      <input type="text" class="form-control" name="name" id="name" placeholder="请输入姓名" maxlength="16" />
			    </div>
			</div>
			
			<div class="form-group">
			    <label for="password" class="col-sm-2 control-label"><span class="error-tip">*&nbsp;</span>密码：</label>
			    <div class="col-sm-3">
			...
			<div class="form-group">
			    <label for="repassword" class="col-sm-2 control-label"><span class="error-tip">*&nbsp;</span>确认密码：</label>
			    <div class="col-sm-3">
			    ...
			    <label for="sex_male" class="col-sm-2 control-label"><span class="error-tip">*&nbsp;</span>用户性别：</label>
			     <div class="col-sm-3">
				    <label class="radio-inline">
					  <input type="radio" name="sex" id="sex_male" checked="checked" value="10">男
					</label>
					<label class="radio-inline">
					  <input type="radio" name="sex" id="sex_female" value="11">女
					</label>
				</div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-3">
			    	<input type="text" class="form-control" name="office_phone" id="office_mobile" >
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-3">
			    	<input type="text" class="form-control" name="mobil_phone" id="mobile" >
			    </div>
			</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#account').blur(function(){
				if($(this).val()){
					$.ajax({
						url:'${ctx}/control/user/validate',
						type:'post',
						dataType:'json',
						data:{'uid':$(this).val()},
						success:function(data){
							flag = data ? data.flag : flag
							$('.msg').html((data && !data.flag) ? '此账户名太受欢迎,请更换一个' : '')
						}
					});
				}
			});
