...
public class IConstants {
	 ...
	 * 提现手续费
	 */
	public final static String WITHDRAW_FEE = "WITHDRAWFEE_FEE";
	/**
	 * jinshajiang
	 * 默认显示限制条数
	 */
	 ...
	 * add by zy 图片验证码校验正确
	 */
	public final static String IMGCODE_VALIDATE_SUCCESS = "0";
	
	/**
	 * add by zy 图片验证码校验失败
	 */
	public final static String IMGCODE_VALIDATE_FAIL = "1";
	
	/**
	 * add by zy 图片验证码已过期
	 */
	public final static String IMGCODE_INVALID = "2";
	
	/**
	 * add by zy 图片验证码为空
	 */
	public final static String IMGCODE_IS_NULL = "3";
	
	/**
	 * add by zy 短信验证码失败
	 */
	public final static String SMS_ERROR_CODE = "2";
	
	/**
	 * add by zy 短信验证码已过期
	 */
	public final static String SMS_INVALID = "SMS_INVALID";
	
	/**
	 * add by zy (新版登录)用户不存在
	 */
	public final static String USER_ISNOT_EXIST = "USER_ISNOT_EXIST";
	
	/**
	 * add by zy (新版登录)密码错误
	 */
	public final static String PASSWORD_IS_WRONG = "PASSWORD_IS_WRONG";
	
	/**
	 * add by zy 用户手机已注册(新版注册)
	 */
	public final static String USERPHONE_IS_REGISTERED = "1";
	
	/**
	 * add by zy 用户手机未注册(新版注册)
	 */
	public final static String USERPHONE_ISNOT_REGISTERED = "0";
	
	/**
	 * add by zy 用户手机号未注册
	 */
	public final static String USER_PHONE_REGISTER_SUCCESS = "1";
	
	/**
	 * add by zy 用户手机号已注册
	 */
	public final static String USER_PHONE_REGISTER_ERROR = "2";
	
	/**
	 * add by zy 邮箱绑定时，公司邮件账号（系统配置表t_sys_config中的key）
	 */
	public final static String COMPANY_EMAIL = "COMPANY_EMAIL";
	
	/**
	 * add by zy 邮箱绑定时，公司邮箱密码（系统配置表t_sys_config中的key）
	 */
	public final static String COMPANY_EMAIL_PASSWORD ="COMPANY_EMAIL_PASSWORD";
	
	/**
	 * add by zy 邮箱绑定时，公司邮箱smtp服务器（系统配置表t_sys_config中的key）
	 */
	public final static String COMPANY_EMAIL_HOST = "COMPANY_EMAIL_HOST";
	
	/**
	 * add by zy 邮箱绑定时，公司邮箱smtp服务器端口（系统配置表t_sys_config中的key）
	 */
	public final static String COMPANY_EMAIL_PORT = "COMPANY_EMAIL_PORT";
	
	public final static int TRADE_RECORD_DEFAULT_DATE = 1;
	
	public final static String APP_KEY = "0TGOgfxFW1lniWeL8tcHqRQw6UFJn979";
	 ...
	 * @since 1.0.0   
	 */   
	public static final int PAGE_SIZE_10 = 5;
...
//	public static final int BANK_CHANGE = 4;
	...
	//时间格式定义
	public final static String DATE_FORMAT_24 = "yyyyMMddHHmmss";
	
	public final static String DATE_FORMAT_YMD = "yyyy-MM-dd";
	
	public final static String DATE_FORMAT_YMDHms = "yyyy-MM-dd HH:mm:ss";
	
	public final static String DATE_FORMAT_YMDHmsms = "yyyyMMddHHmmssms";
	
	public final static String AUTH_BUSINESS_NAME = "钱来网注册用户实名认证服务";
	
	public final static String AUTH_BUSINESS_OPT_CITY_NAME = "深圳市";
	
	public final static String AUTH_BUSINESS_USER_CODE = "szqlszql49701";
	
	public final static int FREE_ERROR = 0;
	
	public final static int COST_ERROR = 1;
	
	public final static int COST_CORRECT = 2;
	
	public final static int TOO_MANY_ERRORS = 0;
	
	public final static int ID_CARD_IS_USED = 3;
	
	public final static int IDENTITY_CARD_NUMBER_OR_NAME_INCORRECT = 1;
	
	public final static int CORRECT_AND_FORWARD_TO_SUCCESSFUL_PAGE = 2;
	
	public final static String AUTHED = "1";
	
	public final static String IS_EQUALS = "EQUALS";
	
	public final static String IS_NOT_EQUALS = "NOTEQUALS";
}
